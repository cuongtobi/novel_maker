# Open Loops — Hương Hỏa Trấn Quỷ

## Status convention
- `PLANNED`: source-backed setup/payoff exists in outline but not accepted prose.
- `OPEN`: setup has appeared in accepted prose and awaits payoff.
- `CLOSED`: payoff accepted in prose.

Current accepted chapter: **10**.

| Loop | Status after C010 | Accepted setup / protected direction | Do not do early |
|---|---|---|---|
...
| Golden incense | PLANNED | dragon rescue episode | explain origin |
| Tân / Bì Tướng Chủ | PLANNED | eighth seat/exam → C100 identity recognition | reveal early |
| Bính/Quý seats | PLANNED | absent at hidden gathering | fabricate identities/reasons |
| Realm 3 | PLANNED | breakthrough resources obtained later but unused by C100 | breakthrough before/at C100 |

## Immediate active loops after C010
1. **Chính-ngọ pressure — OPEN:** Liễu Nương produced a source-backed noon clock in C008. C010 ends with Hoài Chân + Phùng Tĩnh heading toward Bạch Thạch Kiều before noon.
2. **Official-record contradiction — OPEN:** old file blames Lưu Bảo Sơn for Tiểu Miên's death and says Liễu Nương was released/siêu độ, yet Liễu is active now.
...
- C012: Trấn Quỷ Chú/Ấn may unlock at source-equivalent mass-preparation beat.
- C017–18: realm 1 `Điều Long Hổ` only here.

## Loop discipline
- A setup not yet written cannot be treated as an in-world fact learned by characters.
- Closing a loop must update `current_state.md`, `timeline.md`, relevant character knowledge and this file.
- Never reopen a CLOSED source payoff solely to create a new twist.
- Do not add a major open loop without source support or explicit user instruction.
- Minor surface clues may only serve a protected existing loop; they cannot become an independent mystery layer.
